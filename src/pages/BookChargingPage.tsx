...
const locations = ["Miyapur, Hyderabad", "Lakdikapul, Hyderabad", "Secunderabad", "Kukatpally, Hyderabad"];
const chargingTypes = ["5A", "10A", "15A", "20A"];
const stations = ["Zeon Charging Station", "Tata Power Charging Station", "ElectricPe Charging Station", "GLIDA Charging Station"];

const BookChargingPage: React.FC = () => {
    ...
    <div className="min-h-screen bg-background pb-6">
      ...
      <div className="mx-4 mb-4 animate-fade-in-up stagger-1">
        <div className="bg-primary/10 rounded-2xl p-4 border-2 border-border">
          ...
          <input className="ev-input w-full mb-2" placeholder="Enter EV station" value={form.station} onChange={(e) => update("station", e.target.value)} list="stations" />
...
export default BookChargingPage;
